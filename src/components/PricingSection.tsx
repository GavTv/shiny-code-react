const packages = [
  ...
  {
    badge: "Старт",
    period: "1 месяц · Разовое урок-знакомство",
    prices: [
      { amount: "3 840 руб", label: "Дети" },
      { amount: "4 200 руб", label: "Взрослые" },
    ],
  ...
  {
    badge: "Лучший выбор",
    period: "1 месяц · 4 занятия (базовый курс)",
    prices: [
      { amount: "9 240 руб", label: "Дети" },
      { amount: "10 440 руб", label: "Взрослые" },
    ],
  ...
  {
    badge: "Прогресс",
    period: "1 месяц · 8 занятий (развивающий курс)",
    prices: [
      { amount: "17 520 руб", label: "Дети" },
      { amount: "19 440 руб", label: "Взрослые" },
    ],
  ...
  {
    badge: "Мастер",
    period: "3 месяца · 24 занятия (максимальная выгода)",
    prices: [
      { amount: "45 600 руб", label: "Дети" },
      { amount: "52 200 руб", label: "Взрослые" },
    ],
