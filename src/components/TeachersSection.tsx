  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative w-full max-w-[360px] md:max-w-md max-h-[75vh] md:max-h-[80vh] my-4 bg-card rounded-3xl shadow-2xl overflow-hidden animate-scale-in flex flex-col"
      >
        <button
          onClick={onClose}
