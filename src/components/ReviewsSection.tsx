...
const reviews = [
  ...
  {
    name: "Аня В.",
    text: "Дочка ходит на укулеле уже полгода и обожает каждое занятие. Педагоги умеют найти подход к детям, рекомендую!",
    discipline: "Укулеле",
  },
  {
    name: "Дмитрий Л.",
    text: "Записал свою первую песню в их студии — звук получился просто огонь. Ребята помогли с аранжировкой и сведением.",
    discipline: "Звукозапись",
  },
  {
    name: "Катя М.",
