  ...
  return (
    <div className="w-full min-h-screen">
      <SEO
        ...
        description="Разбираем типичные ошибки новичков-гитаристов: постановка рук, ритм, давление на струны. Советы от преподавателей школы Звук Вокруг Поварская."
        ...
        <div className="max-w-3xl mx-auto px-5 space-y-8">
          ...
          <div className="bg-gradient-to-br from-primary/10 to-accent/10 rounded-3xl p-8 mt-12">
            ...
            <p className="text-foreground leading-relaxed mt-4">
              В <strong>Звук Вокруг</strong> пробный урок гитары стоит <strong>1200 руб (45 минут)</strong>. За это время преподаватель оценит ваш текущий уровень, покажет правильную технику и составит план обучения.
            </p>
          </div>
        </div>
      </article>
