      ...
      <article className="py-12 md:py-16">
        <div className="max-w-3xl mx-auto px-5 space-y-8">
          ...
          {[
            ...
            {
              num: 4,
              title: "Доступные цены от 700 руб",
              text: "Пробный урок 45 минут — 700 руб (акция). Абонемент на 4 урока — от 3200 руб (дети) до 7700 руб (взрослые). Прозрачные цены без скрытых доплат.",
            },
            {
              num: 5,
              title: "Отзывы 4.5⭐ на Яндекс Картах",
              text: "150+ отзывов в Яндекс.Картах с рейтингом 4.5. Реальные ученики делятся впечатлениями — это лучшая проверка качества обучения.",
            },
            {
              num: 6,
          ...
          <div className="bg-gradient-to-br from-primary/10 to-accent/10 rounded-3xl p-8 mt-12">
            ...
            <ul className="space-y-2">
              {["Стаж ≥ 5 лет", "Сценический опыт", "Оборудованный класс", "Пробник от 700 ₽", "Высокий рейтинг", "Удобная локация", "Видимые результаты"].map((item) => (
