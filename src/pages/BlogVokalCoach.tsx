        ...
        <div className="max-w-3xl mx-auto px-5 space-y-8">
          ...
          {[
            ...
            },
            {
              ...
              tip: "Звук Вокруг находится в 5 минутах пешком от метро Арбатская (ул. Поварская 7к1). Расписание подстраивается под ученика.",
            },
            {
              num: 7,
          ...
          <div className="flex items-center gap-3 text-muted-foreground text-sm bg-muted rounded-2xl p-4">
            ...
            <span>Звук Вокруг Поварская: ул. Поварская 7к1, 5 мин от м. Арбатская</span>
          </div>
        </div>
      </article>
